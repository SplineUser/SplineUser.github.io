...
description: "Exploring Windows RPC interfaces in Winlogon.exe — hunting misconfigured security callbacks, tracing dispatch tables via dynamic and static analysis, and finding DoS primitives."
---
