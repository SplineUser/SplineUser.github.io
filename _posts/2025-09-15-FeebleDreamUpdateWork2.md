...
**C. Kernel primitives (sKPE)**

**Introduction:** Our research has led us to discover
...
used, It should still work just fine.

**Problem:** Currently our system only loads the
...
**Engineering:** We will use a similar strategy
...
**Testing:** So we are going to test the logic we
have created so far. Let's start with trying A and B first. Here is the
main
code:<img src="/assets/images/FeebleDreamUpdateWork2/image15.png" alt="VisualStudioCode"
...
We see that the Log function does work, now we just
...
This code will now try to create the service if it
doesn't exist. After running the code:

<img src="/assets/images/FeebleDreamUpdateWork2/image2.png" alt="VisualStudioCode"
style="width:6.36458in;height:0.57292in" />

We see our issue got fixed but now we are getting the
...
Lets try and run this now:

<img src="/assets/images/FeebleDreamUpdateWork2/image5.png" alt="VisualStudioCode"
style="width:6.5in;height:0.79167in" />  
<img src="/assets/images/FeebleDreamUpdateWork2/image13.png" alt="VisualStudioCode"
style="width:5.8125in;height:1.58333in" />

It's successful! Therefore, both A and B seem to be
working just fine right now. Now, we can move to the IOCTL logic and
check if that seems to be working as well. Okay lets see what happens
...
allows us to exploit the vulnerable code.
...
**D. System Info Gathering Logic**

**Introduction:** FDv1 had basic capabilities for
...
**Problem:** Our APT simulation tool currently lacks
...
**Engineering:** Interestingly, almost all the
...
**Conclusion:** We were able to finish the driver
...
that could be necessary for us for further LPE.

**Future Work:** In terms of capabilities, we could
