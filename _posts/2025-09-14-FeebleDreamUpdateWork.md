...
**Introduction:** For debugging and information
...
**Problem:** Currently we utilize simple msgbox API
...
shall introduce a much better system for logging.

**Engineering:** We will use modulization and
...
**B. Driver Loading Logic**

**Introduction:** One of the biggest updates in
...
should be resilient and take weird cases into consideration.

**Problem:** Feeble Dream v2.0 was at SYSTEM
...
**Engineering:** We will use a similar approach as
...
**Future work:** Now that we have introduced a new
